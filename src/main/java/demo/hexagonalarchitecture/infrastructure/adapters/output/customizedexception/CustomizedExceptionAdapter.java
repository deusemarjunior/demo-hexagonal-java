package demo.hexagonalarchitecture.infrastructure.adapters.output.customizedexception;
...
import demo.hexagonalarchitecture.infrastructure.adapters.output.customizedexception.data.response.ExceptionResponse;
